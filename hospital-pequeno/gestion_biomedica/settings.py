"""
Base settings for gestion_biomedica project.

Generated by Django and ajusted for the biomedical management portal.
"""
...
ALLOWED_HOSTS: list[str] = ['*']  # Permite conexiones desde cualquier IP
